...
//display details of movie, the trailer videois played when released movie tile is clicked on home page. 
//also books the show for that movie
...
const Details = (props) => {
    ...
    //Takes to the wiki page of artist
