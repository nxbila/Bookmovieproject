...
//header is displayed on top with upcoming movies in top row and released movies below it on the left side
//and search filter is on the right 
...
const Home = (props) => {
    ...
    useEffect(() => {
        ...
        //Get the released movies when  page loads
        ...
        //Get the genre list for the genre filter select menu
        ...
        //Get the artists list for the artists filter select menu
    ...
    /* Handles the apply filter button click. This will build the query string 
