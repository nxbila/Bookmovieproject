...
//displays common header for all screen on top of the page
...
const Header = (props) => {
   ...
   //handler to set state of modal open to track status
   ...
   // Handler  for  login action
    ...
    const loginClickHandler = () => {
        ...
        if (username && loginPassword) {
           ...
           //built the header here with the authentication token
            const headers = {
           ...
           //used axios post to send header to the login API
            axios.post(props.baseUrl + "auth/login", {}, {
                ...
                */
                ...
                /*If the user is shown the login modal because they clicked the book show 
